...
Always ask yourself if what you are about to commit is the best way to do it? Best long term maintainable clean architecture? AND SIMPLEST possible way to achieve the goal. not the implementation but the artchitecture.
